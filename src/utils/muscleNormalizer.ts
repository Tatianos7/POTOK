...
export const MUSCLE_NORMALIZATION_MAP: MuscleNormalizationMap = {
  ...
  'Трапеции': 'Трапециевидная мышца',
  'Трапеция': 'Трапециевидная мышца',
  trapezius: 'Трапециевидная мышца',
  traps: 'Трапециевидная мышца',

  'Верх трапеций': 'Верх трапеций',
  upper_traps: 'Верх трапеций',

  'Средняя часть трапеций': 'Средняя часть трапеций',
  'Средние трапеции': 'Средняя часть трапеций',
  middle_traps: 'Средняя часть трапеций',

  'Низ трапеций': 'Нижняя часть трапеций',
  'Нижняя часть трапеций': 'Нижняя часть трапеций',
  'Нижние трапеции': 'Нижняя часть трапеций',
  lower_traps: 'Нижняя часть трапеций',
