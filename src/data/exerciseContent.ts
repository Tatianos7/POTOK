...
export const exerciseContentMap: Record<string, ExerciseContent> = {
  ...
  "aerobics": {
    "exercise_id": "aerobics",
    "exercise_name": "Аэробика",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Встаньте прямо, ноги на ширине таза, корпус собран. Подготовьтесь к ритмичной связке шагов и движений руками.",
    "execution": "Выполняйте непрерывные аэробные движения в умеренном темпе: шаги, приставные шаги, подъёмы коленей и движения руками. Поддерживайте ровный ритм и контроль корпуса.",
    "top_position": "В рабочей фазе пульс повышен, дыхание учащено, движения остаются координированными и контролируемыми.",
    "return_phase": "Плавно снизьте темп, перейдите на спокойный шаг и восстановите дыхание.",
    "mistakes": [
      "Слишком резкий старт без разминки",
      "Потеря контроля корпуса",
      "Слишком высокий темп при плохой технике",
      "Жёсткие приземления"
    ],
    "breathing": "Дышите ровно и ритмично, не задерживайте дыхание.",
    "safety": "Начинайте с низкой или средней интенсивности. При головокружении, боли в груди или сильной одышке остановитесь.",
    "notes": "Кардио-нагрузка для развития выносливости и общего расхода энергии."
  },
  "treadmill_running": {
    ...
    "start_position": "Встаньте на беговую дорожку, задайте комфортную скорость, корпус держите прямо, взгляд направлен вперёд.",
    "execution": "Бегите в устойчивом темпе, мягко ставя стопу под корпусом. Руки согнуты в локтях и работают естественно вдоль тела.",
    "top_position": "Темп стабилен, дыхание ритмичное, шаг контролируемый, плечи расслаблены.",
    "return_phase": "Постепенно снизьте скорость до лёгкого бега, затем до ходьбы для восстановления.",
    "mistakes": [
      "Слишком длинный шаг",
      "Приземление далеко перед корпусом",
      "Опора руками на поручни",
      "Резкое завершение без заминки"
    ],
    "breathing": "Дышите ритмично: вдох на 2–3 шага, выдох на 2–3 шага или по комфортному ритму.",
    "safety": "Используйте страховочный ключ дорожки. Не увеличивайте скорость резко и не сходите с движущегося полотна.",
    "notes": "Подходит для кардио-тренировок с контролем скорости и наклона."
  },
  "outdoor_running": {
    "exercise_id": "outdoor_running",
    "exercise_name": "Бег на улице",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Начните с лёгкой разминки и спокойного шага. Держите корпус прямо, взгляд направлен вперёд.",
    "execution": "Бегите в комфортном темпе, сохраняя мягкое приземление и естественную работу рук. Подстраивайте скорость под покрытие и самочувствие.",
    "top_position": "Темп устойчивый, дыхание контролируемое, корпус не заваливается вперёд или назад.",
    "return_phase": "Постепенно замедлитесь до лёгкого бега, затем до ходьбы.",
    "mistakes": [
      "Резкий старт без разминки",
      "Слишком высокий темп в начале",
      "Жёсткие приземления",
      "Игнорирование неровностей покрытия"
    ],
    "breathing": "Дышите свободно и ритмично, не задерживайте дыхание.",
    "safety": "Выбирайте безопасное покрытие и обувь. При боли в суставах снизьте темп или перейдите на ходьбу.",
    "notes": "Кардио на открытом воздухе с естественной сменой темпа и рельефа."
  },
  "burpee": {
    "exercise_id": "burpee",
    "exercise_name": "Берпи",
    ...
    "start_position": "Встаньте прямо, ноги на ширине плеч, корпус собран.",
    "execution": "Опуститесь в присед, поставьте ладони на пол, шагом или прыжком отведите ноги назад в планку, затем верните ноги к рукам и выполните подъём или прыжок вверх.",
    "top_position": "В верхней фазе корпус выпрямлен, руки могут подниматься вверх, движение остаётся контролируемым.",
    "return_phase": "Мягко приземлитесь, стабилизируйте корпус и переходите к следующему повторению.",
    "mistakes": [
    ...
    "breathing": "Выдох при подъёме или прыжке, вдох при переходе вниз.",
    "safety": "При проблемах с коленями, поясницей или давлением выполняйте вариант без прыжка и в умеренном темпе.",
    "notes": "Интенсивное кардио-упражнение для всего тела."
  },
  "incline_fast_walking": {
    "exercise_id": "incline_fast_walking",
    "exercise_name": "Быстрая ходьба в гору",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Встаньте на дорожку или выберите подъём. Корпус держите слегка наклонённым вперёд от голеностопа, не сутультесь.",
    "execution": "Идите быстрым шагом вверх, активно работая стопой и ягодицами. Руки двигаются естественно, дыхание ритмичное.",
    "top_position": "Темп устойчивый, пульс повышен, шаг уверенный, корпус не заваливается на поручни.",
    "return_phase": "Снизьте наклон или темп и перейдите на спокойную ходьбу.",
    "mistakes": [
      "Опора на поручни",
      "Слишком большой наклон без контроля",
      "Сутулость",
      "Слишком длинный шаг"
    ],
    "breathing": "Дышите ровно, выдох делайте на усилии подъёма.",
    "safety": "Не держитесь за поручни всем весом. Подбирайте наклон так, чтобы сохранять технику.",
    "notes": "Низкоударное кардио с акцентом на ягодицы и заднюю поверхность бедра."
  },
  "stationary_bike": {
    "exercise_id": "stationary_bike",
    "exercise_name": "Велотренажёр",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Настройте высоту сиденья так, чтобы колено оставалось слегка согнутым в нижней точке педали. Сядьте ровно и возьмитесь за рукояти.",
    "execution": "Крутите педали в ровном темпе, поддерживая стабильный корпус и равномерное усилие обеими ногами.",
    "top_position": "Пульс в рабочей зоне, вращение плавное, колени движутся по линии стоп.",
    "return_phase": "Постепенно снижайте сопротивление и темп до лёгкого вращения.",
    "mistakes": [
    ...
    "breathing": "Дышите ровно и ритмично на протяжении всего подхода.",
    "safety": "Настройте сиденье перед началом. При боли в коленях уменьшите сопротивление и проверьте посадку.",
    "notes": "Кардио с низкой ударной нагрузкой на суставы."
  },
  "rowing_machine": {
    "exercise_id": "rowing_machine",
    "exercise_name": "Гребной тренажёр",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Сядьте на тренажёр, закрепите стопы, возьмитесь за рукоять. В стартовой позиции колени согнуты, корпус слегка наклонён вперёд, спина ровная.",
    "execution": "Оттолкнитесь ногами, затем слегка отклоните корпус назад и подтяните рукоять к нижней части груди или верхней части живота.",
    "top_position": "Ноги почти выпрямлены, рукоять у корпуса, лопатки сведены, спина нейтральна.",
    "return_phase": "Сначала выпрямите руки, затем наклоните корпус вперёд и согните ноги, возвращаясь в старт.",
    "mistakes": [
      "Тяга руками до работы ног",
      "Круглая спина",
      "Слишком сильный отклон корпуса",
      "Рывки рукоятью"
    ],
    "breathing": "Выдох на тяге, вдох при возвращении.",
    "safety": "Сохраняйте нейтральную спину. Не используйте чрезмерное сопротивление, если техника распадается.",
    "notes": "Кардио с активной работой ног, спины и корпуса."
  },
  "interval_running": {
    "exercise_id": "interval_running",
    "exercise_name": "Интервальный бег",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Разомнитесь лёгкой ходьбой или бегом. Подготовьте интервалы высокой и низкой интенсивности.",
    "execution": "Чередуйте быстрые отрезки бега с восстановительными отрезками ходьбы или лёгкого бега.",
    "top_position": "На быстром интервале темп высокий, но техника сохраняется: корпус стабилен, шаг контролируемый.",
    "return_phase": "На восстановительном интервале снизьте скорость, восстановите дыхание и подготовьтесь к следующему ускорению.",
    "mistakes": [
      "Слишком высокая интенсивность с первого интервала",
      "Отсутствие разминки",
      "Потеря техники",
      "Недостаточное восстановление"
    ],
    "breathing": "На быстрых отрезках дыхание учащается, на восстановлении постепенно выравнивается.",
    "safety": "Не выполняйте высокоинтенсивные интервалы без подготовки. При дискомфорте снизьте темп.",
    "notes": "Интервальный формат для развития выносливости и повышения интенсивности тренировки."
  },
  "circuit_training_cardio": {
    "exercise_id": "circuit_training_cardio",
    "exercise_name": "Круговая тренировка",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Подготовьте несколько упражнений, которые выполняются последовательно с коротким отдыхом. Начните с разминки.",
    "execution": "Выполняйте упражнения по кругу, поддерживая умеренно высокий темп и контролируя технику каждого движения.",
    "top_position": "Пульс повышен, работа идёт непрерывно, но техника упражнений остаётся безопасной.",
    "return_phase": "После круга сделайте короткое восстановление или завершите тренировку заминкой.",
    "mistakes": [
      "Слишком быстрый темп с потерей техники",
      "Неподходящий подбор упражнений",
      "Отсутствие пауз",
      "Игнорирование усталости"
    ],
    "breathing": "Дышите ритмично, выдыхайте на усилии в каждом упражнении.",
    "safety": "Подбирайте упражнения под уровень подготовки. При ухудшении техники увеличьте отдых.",
    "notes": "Формат тренировки, объединяющий кардио и силовую выносливость."
  },
  "swimming": {
    "exercise_id": "swimming",
    "exercise_name": "Плавание",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Начните в воде с комфортного стиля плавания. Корпус вытянут, дыхание спокойное.",
    "execution": "Плывите в выбранном стиле, сохраняя ритм движений рук и ног. Держите тело вытянутым и не зажимайте шею.",
    "top_position": "Движения координированы, дыхание синхронизировано с гребками, темп устойчивый.",
    "return_phase": "Снизьте темп, перейдите на спокойное плавание или отдых у бортика.",
    "mistakes": [
      "Задержка дыхания",
      "Слишком напряжённая шея",
      "Потеря ритма",
      "Чрезмерная скорость без техники"
    ],
    "breathing": "Дышите ритмично в соответствии со стилем плавания, не задерживайте дыхание надолго.",
    "safety": "Плавайте только в безопасных условиях. При усталости остановитесь у бортика или перейдите на лёгкий стиль.",
    "notes": "Низкоударное кардио для всего тела."
  },
  "jumping_jacks": {
    "exercise_id": "jumping_jacks",
    "exercise_name": "Прыжки на месте",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Встаньте прямо, ноги вместе, руки вдоль тела.",
    "execution": "Прыгните, разводя ноги в стороны и поднимая руки вверх. Затем прыжком вернитесь в исходное положение.",
    "top_position": "В широкой позиции руки подняты вверх, ноги разведены, корпус стабилен.",
    "return_phase": "Мягко приземлитесь, вернув ноги вместе и руки вниз.",
    "mistakes": [
      "Жёсткое приземление",
      "Завал коленей внутрь",
      "Слишком высокий темп без контроля",
      "Сутулость"
    ],
    "breathing": "Дышите ритмично, не задерживайте дыхание.",
    "safety": "Приземляйтесь мягко. При дискомфорте в коленях выполняйте шаговый вариант без прыжка.",
    "notes": "Простое кардио-упражнение для разминки или интервальной нагрузки."
  },
  "jump_rope_jumps": {
    "exercise_id": "jump_rope_jumps",
    "exercise_name": "Прыжки со скакалкой",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Встаньте прямо, скакалка за спиной, локти близко к корпусу, кисти слегка в стороны.",
    "execution": "Вращайте скакалку кистями и выполняйте небольшие мягкие прыжки на носках.",
    "top_position": "Скакалка проходит под стопами, корпус вертикален, прыжки низкие и ритмичные.",
    "return_phase": "Сохраняйте ритм или плавно остановитесь, снизив скорость вращения.",
    "mistakes": [
      "Высокие прыжки",
    ...
    "breathing": "Дышите ровно в ритме прыжков.",
    "safety": "Используйте подходящую длину скакалки и мягкое покрытие. При боли в голенях или коленях снизьте объём.",
    "notes": "Координационное кардио с высокой нагрузкой на икры."
  },
  "jump_rope": {
    "exercise_id": "jump_rope",
    "exercise_name": "Скакалка",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Возьмите скакалку за рукояти, встаньте прямо, плечи расслаблены, локти близко к телу.",
    "execution": "Вращайте скакалку кистями и выполняйте ритмичные прыжки на носках с минимальной высотой.",
    "top_position": "Темп устойчивый, корпус собран, скакалка проходит под стопами без зацепов.",
    "return_phase": "Плавно остановите вращение и перейдите на спокойный шаг для восстановления.",
    "mistakes": [
    ...
    "breathing": "Дышите ритмично и спокойно.",
    "safety": "Начинайте с коротких интервалов. При дискомфорте в голенях или коленях уменьшите объём прыжков.",
    "notes": "Кардио-упражнение для выносливости, координации и работы стоп."
  },
  "sprints": {
    "exercise_id": "sprints",
    "exercise_name": "Спринты",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Выполните полноценную разминку. Встаньте в стартовую позицию, корпус слегка наклонён вперёд.",
    "execution": "Ускоряйтесь до высокой скорости на коротком отрезке, активно работая руками и ногами.",
    "top_position": "На максимальной скорости корпус стабилен, шаг мощный, руки работают синхронно.",
    "return_phase": "Постепенно замедлитесь и восстановитесь ходьбой или лёгким бегом перед следующим отрезком.",
    "mistakes": [
      "Спринт без разминки",
      "Слишком длинная дистанция при потере техники",
      "Жёсткое приземление",
      "Недостаточное восстановление"
    ],
    "breathing": "Дыхание интенсивное, не задерживайте его. На восстановлении выравнивайте дыхание.",
    "safety": "Высокоинтенсивная нагрузка. Не выполняйте без подготовки или при травмах ног, спины, сердечно-сосудистых ограничениях.",
    "notes": "Интенсивное кардио для скорости и мощности."
  },
  "stepper": {
    "exercise_id": "stepper",
    "exercise_name": "Степпер",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Встаньте на степпер, стопы полностью на платформах, корпус прямо, руки легко держатся за рукояти при необходимости.",
    "execution": "Выполняйте попеременные шаговые движения вниз и вверх, сохраняя ровный темп и контроль коленей.",
    "top_position": "Пульс повышен, движение ритмичное, нагрузка ощущается в ягодицах и ногах.",
    "return_phase": "Постепенно уменьшите темп и сопротивление, затем остановитесь.",
    "mistakes": [
      "Сильная опора на рукояти",
      "Завал коленей внутрь",
      "Сутулость",
      "Слишком короткая амплитуда"
    ],
    "breathing": "Дышите ровно, сохраняйте ритм дыхания под шаги.",
    "safety": "Не переносите вес полностью на руки. Контролируйте колени и не начинайте с чрезмерного сопротивления.",
    "notes": "Кардио с акцентом на ноги и ягодицы."
  },
  "dance_cardio": {
    "exercise_id": "dance_cardio",
    "exercise_name": "Танцевальное кардио",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Встаньте свободно, подготовьтесь к ритмичным движениям под музыку, корпус расслаблен и собран.",
    "execution": "Выполняйте танцевальные шаги, повороты и движения руками в умеренном или высоком темпе.",
    "top_position": "Движения ритмичные, пульс повышен, координация сохраняется, корпус стабилен.",
    "return_phase": "Постепенно снизьте интенсивность, перейдите на спокойные шаги и восстановите дыхание.",
    "mistakes": [
      "Слишком резкие движения без разминки",
      "Потеря контроля коленей",
      "Жёсткие приземления",
      "Слишком высокий темп"
    ],
    "breathing": "Дышите свободно и ритмично.",
    "safety": "Выбирайте амплитуду под свой уровень. При дискомфорте в суставах уменьшите прыжки и повороты.",
    "notes": "Кардио в танцевальном формате для выносливости и координации."
  },
  "walking": {
    "exercise_id": "walking",
    "exercise_name": "Ходьба",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Встаньте прямо, плечи расслаблены, взгляд направлен вперёд.",
    "execution": "Идите в комфортном или быстром темпе, мягко перекатывая стопу с пятки на носок. Руки двигаются естественно.",
    "top_position": "Темп устойчивый, дыхание слегка учащено, корпус прямой.",
    "return_phase": "Постепенно замедлитесь до спокойного шага.",
    "mistakes": [
      "Сутулость",
      "Слишком длинный шаг",
      "Зажатые плечи",
      "Резкое увеличение темпа без разминки"
    ],
    "breathing": "Дышите спокойно и ритмично.",
    "safety": "Подбирайте удобную обувь и безопасное покрытие. Увеличивайте длительность постепенно.",
    "notes": "Базовое низкоударное кардио для ежедневной активности."
  },
  "elliptical_trainer": {
    "exercise_id": "elliptical_trainer",
    "exercise_name": "Эллиптический тренажёр",
    "category": "cardio",
    "technique_image_url": "",
    "primary_muscles": [
      "cardio"
    ...
    "start_position": "Встаньте на педали эллиптического тренажёра, возьмитесь за рукояти, корпус держите прямо.",
    "execution": "Двигайтесь плавно по эллиптической траектории, равномерно работая ногами и руками.",
    "top_position": "Темп устойчивый, корпус стабилен, движение без ударной нагрузки и рывков.",
    "return_phase": "Постепенно снижайте сопротивление и темп до полной остановки.",
    "mistakes": [
      "Сутулость",
      "Чрезмерная опора на рукояти",
      "Слишком быстрое движение без контроля",
      "Завал коленей внутрь"
    ],
    "breathing": "Дышите ровно и ритмично на протяжении всей работы.",
    "safety": "Начинайте с умеренного сопротивления. Не переносите весь вес на рукояти и контролируйте положение коленей.",
    "notes": "Низкоударное кардио для общей выносливости."
  },
  "stairs_or_stepups": {
