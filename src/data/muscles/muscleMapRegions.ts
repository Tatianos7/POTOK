...
export const muscleMapRegions: Record<MuscleKey, MuscleMapRegionMap> = {
  ...
  abs: { front: ['abs'] },
  obliques: { front: ['obliques_front'] },
  hip_flexors: { front: ['hip_flexors'] },
  core: { front: ['core_front'] },
  core_muscles: { front: ['core_front'] },
  quads: { front: ['quads'] },
  ...
  trapezoid: { back: ['traps_upper', 'traps_middle', 'trapezoid'] },
  traps: { back: ['traps_upper', 'traps_middle', 'trapezoid'] },
  trapezius: { back: ['traps_upper', 'traps_middle', 'trapezoid'] },
  traps_upper: { back: ['traps_upper'] },
  upper_traps: { back: ['traps_upper'] },
  traps_middle: { back: ['traps_middle'] },
  middle_traps: { back: ['traps_middle'] },
  lower_traps: { back: ['trapezoid'] },
